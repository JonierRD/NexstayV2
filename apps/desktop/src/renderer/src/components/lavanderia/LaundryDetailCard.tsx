...
export function LaundryDetailCard({
    ...
    return (
        <section className="flex min-h-0 w-full flex-col rounded-[26px] border border-sapay-350 bg-white shadow-[0_20px_50px_rgba(67,42,27,0.08)] xl:w-[380px]">
            <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[26px] p-4">
                ...
                <div className="rounded-xl border border-sapay-300 bg-sapay-150 px-4 py-3 text-[12px]">
                    <h4 className="mb-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-sapay-650">Descripción</h4>
                    <p className="text-sapay-950">{laundry.description}</p>
                </div>
                ...
                {laundry.notes && (
                    <div className="mt-2 rounded-xl border border-sapay-300 bg-sapay-150 px-4 py-3 text-[12px]">
                        <h4 className="mb-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-sapay-650">Notas</h4>
                        <p className="text-sapay-950">{laundry.notes}</p>
                    </div>
                )}
                ...
                <div className="mt-auto flex flex-col gap-2 pt-3">
                    {status !== 'ENTREGADO' && (
                        <AccentButton
                            ...
                            className="w-full gap-1.5 bg-sapay-900 text-white hover:bg-[#5b3428]"
                        >
                    ...
                    <div className="flex gap-2">
                        ...
                        <AccentButton
                            onClick={onDelete}
                            className="flex-1 gap-1.5 border-danger-150 bg-white text-[#d13d3d] hover:border-[#e5a0a0] hover:bg-[#fff5f5]"
                        >
